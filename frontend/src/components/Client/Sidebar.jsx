...
//     // { name: "Chat", icon: MessageSquare, to: "/client/chat" },
...
//       <aside
//         className={`fixed top-0 left-0 z-109 h-screen w-72
//         bg-gradient-to-b from-white via-indigo-50/40 to-purple-50/40
//         shadow-xl border-r border-indigo-100
...
//               <img src={logo} className="w-14 h-14 rounded-xl" />
//               <div>
//                 <h2 className="font-bold text-lg text-indigo-600">Kuber</h2>
