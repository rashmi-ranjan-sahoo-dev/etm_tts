            ...
            <table className="min-w-full w-full text-sm">
              <thead>
                <tr className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b-2 border-blue-100">
                  ...
                  {activeTab === "tasks" && (
                    <th className="p-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Task Due Date</th>
                  )}
                  <th className="p-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Attachments</th>
                </tr>
              </thead>
              ...
              <tbody className="divide-y divide-gray-100">
                {filteredTasks.map((t) => (
                  ...
                  >
                    ...
                    <td className="p-4 text-gray-600 text-xs">{t.TaskDate}</td>
                    {activeTab === "tasks" && (
                      <td className="p-4 text-gray-600 text-xs font-medium">{t.TaskDueDate}</td>
                    )}
                    <td className="p-4">
                      <button
                        onClick={(e) => openAttachmentModal(t, e)}
          ...
          {filteredTasks.map((t) => (
            ...
            >
              ...
              <div className="space-y-2.5">
                ...
                {activeTab === "tasks" && t.TaskDueDate && (
                  <div className="flex items-start gap-2">
                    <span className="text-xs font-semibold text-gray-500 uppercase tracking-wide min-w-24">Due Date:</span>
                    <span className="text-sm font-medium text-gray-900">{t.TaskDueDate}</span>
                  </div>
                )}
