    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-5 rounded-2xl border-2 border-blue-200">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm font-semibold text-gray-900">{task.Employee_ID}</p>
              </div>
              <div>
                <label className="block text-xs font-bold text-blue-700 uppercase mb-1">
                  Employee Name
                </label>
                <p className="text-sm font-semibold text-gray-900">{task.Employee_Name || "N/A"}</p>
              </div>
              <div>
                <label className="block text-xs font-bold text-blue-700 uppercase mb-1">
                  Department
                </label>
                <p className="text-sm font-semibold text-gray-900">{task.Department || "N/A"}</p>
              </div>
              <div>
                <label className="block text-xs font-bold text-blue-700 uppercase mb-1">
                  Role
                </label>
                <p className="text-sm font-semibold text-gray-900">{task.Role || "N/A"}</p>
              </div>
            </div>
          </div>
          ...
          <button
            onClick={() => onMarkReview(task.TaskNumber)}
            className={`w-full flex items-center justify-center gap-3 px-6 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-2xl hover:scale-105 active:scale-95 transition-all ${
              isReviewed
                ? "bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white"
                : "bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white"
            }`}
...
const TaskModal = ({ close, save, editData, projects }) => {
  ...
  const handleSubmit = () => {
    if (!formData.TaskNumber.trim()) return alert("Task Number is required");
    if (!formData.Employee_ID.trim()) return alert("Employee ID is required");
    if (!formData.Employee_Name.trim()) return alert("Employee Name is required");
    if (!formData.Department.trim()) return alert("Department is required");
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 bg-white focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10"
                  placeholder="e.g., EMP20215"
                />
              </div>
              <div>
          ...
          <div className="flex gap-3 pt-4">
            <button
              onClick={handleSubmit}
              className="flex-1 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-3 rounded-xl hover:from-indigo-700 hover:to-purple-700 shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 font-semibold transition-all"
            >
              {editData ? "Update Task" : "Create Task"}
            </button>
            <button
