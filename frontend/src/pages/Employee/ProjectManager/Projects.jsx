...
//           className="w-full md:w-80 px-4 py-3 border rounded-xl
...
//               className={`cursor-pointer bg-white p-5 rounded-xl shadow-sm
...
//                       p-3 border rounded-lg mb-2 cursor-pointer
