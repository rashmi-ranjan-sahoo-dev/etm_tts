...
// import { Search, Plus, Pencil, Trash2, Download, CheckCircle2, Clock, XCircle, DollarSign, FileText } from "lucide-react";
...
//             {editData ? "Update payment information" : "Add a new client payment"}
//           </p>
//         </div>
...
//             <div>
//               <label className="block text-sm font-semibold text-gray-700 mb-2">Invoice Name</label>
//               <input
//                 type="text"
//                 required
...
//               <button className="w-12 h-12 flex items-center justify-center rounded-xl bg-gradient-to-r from-blue-500 to-indigo-500 text-white hover:from-blue-600 hover:to-indigo-600 transition-all shadow-lg hover:shadow-xl hover:scale-105 active:scale-95">
//                 <Download size={20} />
//               </button>
//             </div>
//           </div>
...
//                   <th className="p-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">ID</th>
...
//                   <th className="p-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Method</th>
...
//                   <tr key={p.id} className="hover:bg-violet-50/50 transition-colors duration-150 cursor-pointer group">
//                     <td className="p-4">
//                       <span className="font-semibold text-violet-600 group-hover:text-violet-700">#{p.id}</span>
//                     </td>
//                     <td className="p-4">
//                       <div>
...
//           {filteredPayments.map((p) => (
//             <div key={p.id} className="bg-white rounded-2xl shadow-lg shadow-violet-100/50 p-5 space-y-3 border border-violet-100/50 hover:shadow-xl hover:shadow-violet-200/50 transition-all duration-300">
//               <div className="flex items-start justify-between gap-3">
//                 <div className="flex-1">
//                   <div className="flex items-center gap-2 mb-1">
//                     <span className="font-bold text-lg text-violet-600">#{p.id}</span>
//                     {getStatusIcon(p.status)}
//                   </div>
//                   <div className="font-semibold text-gray-900">{p.clientName}</div>
//                   <div className="text-xs text-gray-500">{p.clientId}</div>
...
//                   <div className="font-bold text-xl text-gray-900">${p.amount}</div>
...
//                   <span className="text-xs font-semibold text-gray-500 uppercase tracking-wide min-w-20">Method:</span>
...
//                 <div className="flex items-start gap-2">
//                   <span className="text-xs font-semibold text-gray-500 uppercase tracking-wide min-w-20">TXN ID:</span>
//                   <span className="text-sm text-gray-700">{p.transactionId}</span>
//                 </div>

//                 <div className="flex items-start gap-2">
//                   <span className="text-xs font-semibold text-gray-500 uppercase tracking-wide min-w-20">Status:</span>
//                   {statusBadge(p.status)}
//                 </div>
//               </div>
