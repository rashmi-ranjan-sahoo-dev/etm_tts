...
//   return (
//     <div className="w-full max-w-400 mx-auto px-3 sm:px-5 py-4 space-y-6">
...
//           {/* Chart Wrapper */}
//           <div className="w-full max-w-90 h-55 sm:h-65 md:h-75">
...
const Dashboard = () => {
  ...
  return (
    <div className="w-full max-w-screen-2xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 py-4 space-y-6">
      <h1 className="text-xl sm:text-2xl font-semibold">Dashboard</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm flex flex-col items-center">
          <h2 className="font-semibold mb-3">Running Project Review</h2>
          <div className="w-full h-[220px] sm:h-[260px] md:h-[300px] lg:h-[340px]">
            <ResponsiveContainer>
              <RadialBarChart innerRadius="65%" outerRadius="90%" barSize={12} data={radialData}>
          ...
          <p className="font-bold mt-3">Total Progress: {totalProgress}%</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        <div className="bg-white rounded-xl p-4 shadow-sm">
          <h2 className="font-semibold mb-3">My Team</h2>
          <div className="space-y-3 max-h-[260px] sm:max-h-[320px] md:max-h-[380px] overflow-auto">
            {teamData.map((m, i) => (
              <div key={i} className="flex justify-between items-center border-b pb-2">
                <div className="flex gap-3">
                  <img src={m.avatar} className="w-9 h-9 rounded-full" />
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm xl:col-span-2">
          <h2 className="font-semibold mb-3">My Tasks</h2>
          <div className="relative overflow-x-auto max-h-[280px] sm:max-h-[350px] md:max-h-[420px]">
              ...
              <tbody>
                {taskData.map((t, i) => (
                  <tr key={i} className="border-b">
                    ...
                    <td>
                      <div className="w-full bg-gray-200 h-2 rounded">
                        <div className="bg-blue-600 h-2 rounded" style={{ width: `${t.progress}%` }} />
                      </div>
                    </td>
                  </tr>
                ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl p-4 shadow-sm">
          ...
          <div className="overflow-x-auto overflow-y-auto max-h-[300px] sm:max-h-[380px] md:max-h-[450px]">
                ...
                {attendanceData
                  ...
                  .map((a, i) => (
                    <tr key={i} className="border-b">
                      ...
                      <td>{a.hours}</td>
                      <td>
                        <span className={`px-2 py-1 rounded text-xs ${a.status === "Present" ? "bg-green-100 text-green-700" : "bg-orange-100 text-orange-700"}`}>
                          {a.status}
                        </span>
                      </td>
                    </tr>
