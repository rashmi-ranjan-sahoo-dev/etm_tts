          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-xl border-2 bg-gray-50 focus:outline-none focus:bg-white focus:ring-4 transition-all ${errors.deptId ? "border-red-400 focus:ring-red-500/10" : "border-gray-200 focus:border-purple-500 focus:ring-purple-500/10"
                  }`}
              />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-xl border-2 bg-gray-50 focus:outline-none focus:bg-white focus:ring-4 transition-all ${errors.deptName ? "border-red-400 focus:ring-red-500/10" : "border-gray-200 focus:border-purple-500 focus:ring-purple-500/10"
                  }`}
              />
              ...
              <tbody className="divide-y divide-gray-100">
                {filtered.map(row => (
                  <tr key={row.id} className="hover:bg-purple-50/50 transition-colors group">
                    ...
                    <td className="p-4">
                      <span
                        onClick={() => navigate('/admin/employee', { state: { dept: row.deptName } })}
                        className="font-bold text-purple-600 group-hover:text-purple-700 cursor-pointer hover:underline"
                      >
                        {row.deptName}
                      </span>
                    </td>
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-2">
                        <div
                          className="bg-indigo-100 text-indigo-700 px-3 py-1 rounded-lg font-bold flex items-center gap-1"
                        >
            ...
            <div key={row.id} className="bg-white rounded-2xl shadow-lg p-5 border border-purple-100/50">
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <h3
                    onClick={() => navigate('/admin/employee', { state: { dept: row.deptName } })}
                    className="text-xl font-bold text-purple-600 cursor-pointer hover:underline"
                  >
                    {row.deptName}
                  </h3>
                </div>
