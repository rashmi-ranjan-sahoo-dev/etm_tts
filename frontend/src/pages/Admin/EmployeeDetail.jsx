...
const InputField = ({
    ...
    <div>
        ...
        <input
            ...
            className={`w-full px-4 py-2.5 rounded-lg border-2 bg-gray-50 focus:outline-none focus:bg-white transition-all ${error ? "border-red-400" : "border-gray-200 focus:border-teal-500"
                }`}
        />
    ...
    useEffect(() => {
        if (editData) {
            if (editData.firstName && editData.lastName) {
                // If we already have split names, use them
                setForm({
                    ...editData,
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    value={form.dept}
                                    onChange={handleChange}
                                    className={`w-full px-4 py-2.5 rounded-lg border-2 bg-gray-50 focus:outline-none focus:bg-white ${errors.dept
                                        ? "border-red-400"
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    value={form.gender}
                                    onChange={handleChange}
                                    className={`w-full px-4 py-2.5 rounded-lg border-2 bg-gray-50 focus:outline-none focus:bg-white ${errors.gender
                                        ? "border-red-400"
                                        : "border-gray-200 focus:border-teal-500"
                                        }`}
                                >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    placeholder="Address..."
                                    className={`w-full px-4 py-2.5 rounded-lg border-2 bg-gray-50 resize-none focus:outline-none focus:bg-white ${errors.address
                                        ? "border-red-400"
                                        : "border-gray-200 focus:border-teal-500"
                                        }`}
                                />
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        ...
                        <div className="flex flex-col md:flex-row gap-3 w-full md:w-auto">
                            <select
                                ...
                                className="px-4 py-3 rounded-xl border-2 border-gray-100 focus:border-teal-500 bg-white text-gray-600 outline-none cursor-pointer"
                            >
                        ...
                        <div className="w-80 bg-white rounded-2xl shadow-lg p-6 border border-teal-100/50 space-y-6 hidden lg:block">
                            ...
                            <div className="space-y-4">
                                <button
                                    ...
                                    className={`w-full text-left px-4 py-2.5 rounded-lg ${quickFilter.type === "all"
                                    ...
                                    <div className="space-y-1">
                                        {uniqueRoles.map((r, i) => (
                                            <button
                                                ...
                                                className={`w-full text-left px-4 py-2 rounded-lg text-sm ${quickFilter.type === "role" && quickFilter.value === r
                                    ...
                                    <div className="space-y-1">
                                        {uniqueDepts.map((d, i) => (
                                            <button
                                                ...
                                                className={`w-full text-left px-4 py-2 rounded-lg text-sm ${quickFilter.type === "dept" && quickFilter.value === d
                                    ...
                                    <div className="space-y-1">
                                        {uniqueGenders.map((g, i) => (
                                            <button
                                                ...
                                                className={`w-full text-left px-4 py-2 rounded-lg text-sm ${quickFilter.type === "gender" &&
                                                    quickFilter.value === g
