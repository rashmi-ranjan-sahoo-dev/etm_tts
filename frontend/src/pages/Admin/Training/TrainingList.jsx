...
// import { Search, Plus, Pencil, Trash2, BookOpen, User, Clock, DollarSign, Calendar, Activity, X, ChevronDown, ArrowLeft, Mail, Phone, Briefcase, MapPin } from "lucide-react";
// import { useNavigate } from "react-router-dom";

// // TrainingModal Component
// // Mock employees list for selection
// const AVAILABLE_EMPLOYEES = [
//     { id: 1, name: "John Doe", role: "Software Engineer", department: "Development", email: "john.doe@techcorp.com", phone: "+1 (555) 123-4567", status: "Active", joinedDate: "Jan 15, 2023", image: "https://images.unsplash.com/photo-1599566150163-29194dcaad36?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//     { id: 2, name: "Alice Smith", role: "UI/UX Designer", department: "Design", email: "alice.smith@techcorp.com", phone: "+1 (555) 234-5678", status: "Active", joinedDate: "Feb 20, 2023", image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//     { id: 3, name: "Bob Brown", role: "Product Manager", department: "Product", email: "bob.brown@techcorp.com", phone: "+1 (555) 345-6789", status: "On Leave", joinedDate: "Mar 10, 2022", image: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//     { id: 4, name: "Jane Smith", role: "Data Scientist", department: "Data", email: "jane.smith@techcorp.com", phone: "+1 (555) 456-7890", status: "Active", joinedDate: "Apr 05, 2023", image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//     { id: 5, name: "Mike Ross", role: "DevOps Engineer", department: "Engineering", email: "mike.ross@techcorp.com", phone: "+1 (555) 567-8901", status: "Active", joinedDate: "May 12, 2023", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//     { id: 6, name: "Sarah Connor", role: "Security Analyst", department: "Security", email: "sarah.connor@techcorp.com", phone: "+1 (555) 678-9012", status: "Active", joinedDate: "Jun 18, 2022", image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//     { id: 7, name: "Tom Hardy", role: "Backend Developer", department: "Development", email: "tom.hardy@techcorp.com", phone: "+1 (555) 789-0123", status: "Inactive", joinedDate: "Jul 25, 2023", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//     { id: 8, name: "Emma Wilson", role: "Product Designer", department: "Design", email: "emma.wilson@techcorp.com", phone: "+1 (555) 890-1234", status: "Active", joinedDate: "Aug 30, 2023", image: "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//     { id: 9, name: "Chris Evans", role: "QA Engineer", department: "QA", email: "chris.evans@techcorp.com", phone: "+1 (555) 901-2345", status: "Active", joinedDate: "Sep 14, 2022", image: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//     { id: 10, name: "Diana Prince", role: "Project Manager", department: "Product", email: "diana.prince@techcorp.com", phone: "+1 (555) 012-3456", status: "Active", joinedDate: "Oct 22, 2023", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
// ];
...
//     const handleSubmit = () => {
//         const { trainingType, trainer, trainees, timeDuration, cost, trainingDate, completionDate } = formData;
...
//                             <label className="block text-sm font-semibold text-gray-700 mb-2">Trainees</label>

//                             <div
//                                 className={`w-full px-4 py-3 rounded-xl border-2 cursor-pointer flex justify-between items-center transition-all ${showTraineeDropdown
...
//                             >
//                                 <span className={`text-gray-700 ${formData.trainees.length === 0 && 'text-gray-400'}`}>
//                                     {formData.trainees.length > 0
//                                         ? formData.trainees.map(t => t.name).join(", ")
//                                         : "Select Trainees..."
//                                     }
//                                 </span>
//                                 <ChevronDown size={18} className={`text-gray-400 transition-transform duration-200 ${showTraineeDropdown ? 'rotate-180 text-violet-500' : ''}`} />
//                             </div>

//                             {/* Dropdown with Checkbox style selection */}
//                             {showTraineeDropdown && (
//                                 <div className="absolute top-full left-0 w-full mt-2 bg-white rounded-xl shadow-xl border border-gray-100 max-h-60 overflow-hidden z-20">
//                                     <div className="overflow-y-auto max-h-52 p-2">
//                                         <div className="text-xs font-semibold text-gray-400 px-2 py-1 mb-1 uppercase tracking-wider">All Employees</div>
//                                         {AVAILABLE_EMPLOYEES.map((emp) => {
//                                             const isSelected = formData.trainees.some(t => t.name === emp.name);
//                                             return (
//                                                 <div
//                                                     key={emp.id}
//                                                     onClick={() => {
...
//                                                         if (isSelected) {
//                                                             // Remove
//                                                             newTrainees = formData.trainees.filter(t => t.name !== emp.name);
//                                                         } else {
//                                                             // Add
//                                                             newTrainees = [...formData.trainees, { name: emp.name, image: emp.image }];
//                                                         }
//                                                         setFormData({ ...formData, trainees: newTrainees });
//                                                         // Don't close dropdown to allow multiple selections easily
//                                                     }}
//                                                     className={`flex items-center justify-between p-2 rounded-lg cursor-pointer transition-colors ${isSelected ? 'bg-violet-50' : 'hover:bg-gray-50'}`}
//                                                 >
//                                                     <div className="flex items-center gap-3">
//                                                         <div className={`w-8 h-8 rounded-full overflow-hidden border ${isSelected ? 'border-violet-200' : 'border-gray-200'}`}>
//                                                             <img src={emp.image} alt={emp.name} className="w-full h-full object-cover" />
//                                                         </div>
//                                                         <span className={`font-medium ${isSelected ? 'text-violet-700' : 'text-gray-700'}`}>{emp.name}</span>
//                                                     </div>
//                                                     {isSelected && <div className="w-2 h-2 rounded-full bg-violet-500 mr-2"></div>}
//                                                 </div>
//                                             );
//                                         })}
//                                     </div>
//                                     <div
//                                         onClick={() => {
//                                             // Select all trainees at once
//                                             const allTrainees = AVAILABLE_EMPLOYEES.map(emp => ({
//                                                 name: emp.name,
//                                                 image: emp.image
//                                             }));
//                                             setFormData({ ...formData, trainees: allTrainees });
//                                         }}
//                                         className="p-2 text-center border-t border-gray-100 text-xs text-violet-600 bg-violet-50/50 cursor-pointer hover:bg-violet-100/50 transition-colors font-semibold"
//                                     >
//                                         Select All Trainees
//                                     </div>
//                                 </div>
...
// // View Trainees Modal
// const TraineesListModal = ({ close, trainees, onAddTrainee, trainingId }) => {
...
//         onAddTrainee(trainingId, { name: employee.name, image: employee.image });
//         setShowAddDropdown(false);
//     };

//     // Filter out employees already in the list
//     const availableToAdd = AVAILABLE_EMPLOYEES.filter(
//         emp => !trainees.some(t => t.name === emp.name)
//     );

//     return (
//         <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
//             <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[600px]">
...
//                         </h3>
//                     </div>
//                     <button onClick={close} className="p-1 hover:bg-gray-100 rounded-full transition-colors text-gray-500">
//                         <X size={20} />
//                     </button>
//                 </div>
...
//                                 <span className="text-sm font-medium text-gray-500">{trainees.length} Trainees</span>
//                                 <div className="relative">
//                                     <button
//                                         onClick={() => setShowAddDropdown(!showAddDropdown)}
//                                         className="text-xs font-semibold text-violet-600 hover:bg-violet-50 px-2 py-1 rounded-lg transition-colors flex items-center gap-1"
//                                     >
//                                         <Plus size={14} /> Add Trainee
//                                     </button>

//                                     {/* Add Trainee Dropdown */}
//                                     {showAddDropdown && (
//                                         <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-xl shadow-xl border border-gray-100 max-h-60 overflow-y-auto z-20 p-2">
//                                             <div className="text-xs font-semibold text-gray-400 px-2 py-1 mb-1 uppercase tracking-wider">Select Employee</div>
...
//                                                 ))
//                                             ) : (
//                                                 <div className="text-center py-2 text-xs text-gray-500">No employees available</div>
//                                             )}
//                                         </div>
//                                     )}
//                                 </div>
...
//                                             )}
//                                         </div>
//                                         <span className="font-semibold text-gray-700 group-hover:text-violet-700 transition-colors">{t.name}</span>
//                                     </div>
...
//                             ))}
//                             {trainees.length === 0 && (
//                                 <div className="text-center py-4 text-gray-500 text-sm">No trainees assigned</div>
//                             )}
//                         </div>
//                     ) : (
//                         // Detailed View
...
//                                     <img
//                                         src={selectedTrainee.image || "https://images.unsplash.com/photo-1633332755192-727a05c4013d?w=100&h=100&fit=crop"}
//                                         alt={selectedTrainee.name}
//                                         className="w-full h-full object-cover"
//                                     />
//                                 </div>
//                                 <h2 className="text-xl font-bold text-gray-900">{selectedTrainee.name || "Unknown"}</h2>
...
//                                         <p className="text-sm font-semibold text-gray-700">{selectedTrainee.department || "N/A"}</p>
//                                     </div>
//                                 </div>
...
//                                         <p className="text-sm font-semibold text-gray-700">{selectedTrainee.email || "N/A"}</p>
//                                     </div>
//                                 </div>
...
//                                         <p className="text-sm font-semibold text-gray-700">{selectedTrainee.phone || "N/A"}</p>
//                                     </div>
//                                 </div>

//                                 <div className="flex justify-between pt-2">
//                                     <div className="text-xs text-gray-400">
//                                         Joined: <span className="text-gray-600 font-medium">{selectedTrainee.joinedDate || "N/A"}</span>
//                                     </div>
//                                     <div className="text-xs text-gray-400">
//                                         Status: <span className="text-green-600 font-medium">{selectedTrainee.status || "Active"}</span>
//                                     </div>
//                                 </div>
//                             </div>
//                         </div>
...
//             trainees: [
//                 { name: "John Doe", image: "https://images.unsplash.com/photo-1599566150163-29194dcaad36?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//                 { name: "Alice Smith", image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//                 { name: "Bob Brown", image: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" }
//             ],
...
//             trainees: [
//                 { name: "Jane Smith", image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//                 { name: "Mike Ross", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" }
//             ],
...
//             trainer: "David Kim",
//             trainees: [
//                 { name: "Sarah Connor", image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//                 { name: "Tom Hardy", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//                 { name: "Emily Blunt", image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//                 { name: "Chris Evans", image: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
...
//             trainees: [
//                 { name: "Alice Brown", image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" }
//             ],
...
//             trainees: [
//                 { name: "Charlie Davis", image: "https://images.unsplash.com/photo-1527980965255-d3b416303d12?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//                 { name: "Diana Prince", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" },
//                 { name: "Bruce Wayne", image: "https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" }
//             ],
...
//     const [viewTrainingId, setViewTrainingId] = useState(null);
...
//         const mappedType = mapTrainingType(t.trainingType);
//         navigate("/admin/all-trainees", { state: { trainingType: mappedType } });
//     };

//     const handleTraineeClick = (e, traineeName) => {
//         e.stopPropagation();
//         const fullTrainee = AVAILABLE_EMPLOYEES.find(emp => emp.name === traineeName);

//         if (fullTrainee) {
//             // Ensure we pass all necessary fields that TraineeDetails expects
//             const traineeData = {
//                 ...fullTrainee,
//                 traineeId: `TR${fullTrainee.id.toString().padStart(4, '0')}`, // Generate a mock ID if missing
...
//     const handleAddTrainee = (trainingId, newTrainee) => {
//         setTrainings(prev => prev.map(t => {
//             if (t.id === trainingId) {
//                 return {
//                     ...t,
//                     trainees: [...t.trainees, newTrainee]
//                 };
//             }
//             return t;
//         }));
...
//                                     <th className="p-4 font-bold text-gray-700 uppercase tracking-wider">Trainees</th>
...
//                                                     <div
//                                                         key={idx}
//                                                         className="w-10 h-10 rounded-full border-2 border-white shadow-sm overflow-hidden bg-gray-100 relative hover:z-10 transition-all hover:scale-110 cursor-pointer"
//                                                         title={trainee.name}
//                                                         onClick={(e) => handleTraineeClick(e, trainee.name)}
//                                                     >
//                                                         {trainee.image ? (
...
//                                                 {t.trainees.length > 3 && (
//                                                     <div
//                                                         className="w-10 h-10 rounded-full border-2 border-white shadow-sm bg-violet-500 text-white flex items-center justify-center text-xs font-bold relative hover:z-10 transition-all hover:scale-110 cursor-pointer"
//                                                         onClick={(e) => {
//                                                             e.stopPropagation();
//                                                             setViewTrainingId(t.id);
...
//                                         <td className="p-4">
//                                             <span className={`px-3 py-1 rounded-full text-xs font-semibold whitespace-nowrap ${getStatusColor(t.status)}`}>
//                                                 {t.status}
//                                             </span>
//                                         </td>
...
//                                     <span className={`inline-block mt-1 px-2 py-0.5 rounded-md text-xs font-semibold whitespace-nowrap ${getStatusColor(t.status)}`}>
//                                         {t.status}
//                                     </span>
//                                 </div>
...
//                                             <div
//                                                 key={idx}
//                                                 className="w-8 h-8 rounded-full border-2 border-white overflow-hidden bg-gray-50 cursor-pointer hover:z-10 hover:scale-110 transition-all"
//                                                 onClick={(e) => handleTraineeClick(e, trainee.name)}
//                                             >
//                                                 {trainee.image ? (
//                                                     <img src={trainee.image} alt={trainee.name} className="w-full h-full object-cover" />
...
//                                         {t.trainees.length > 3 && (
//                                             <div
//                                                 className="w-8 h-8 rounded-full border-2 border-white bg-violet-500 text-white flex items-center justify-center text-xs font-bold cursor-pointer"
//                                                 onClick={(e) => {
//                                                     e.stopPropagation();
//                                                     setViewTrainingId(t.id);
//                                                     setShowViewModal(true);
...
//             {/* View Trainees Modal */}
//             {showViewModal && viewTrainingId && (
//                 <TraineesListModal
//                     close={() => {
//                         setShowViewModal(false);
//                         setViewTrainingId(null);
//                     }}
//                     trainees={trainings.find(t => t.id === viewTrainingId)?.trainees || []}
//                     trainingId={viewTrainingId}
...
const TrainingModal = ({ close, save, editData }) => {
    ...
    const handleSubmit = () => {
        const { trainingType, trainer, trainees, timeDuration, cost, trainingDate, certificationDate } = formData;
                        ...
                        <table className="w-full text-sm text-left">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {filteredTrainings.map((t) => (
                                    <tr
                                        key={t.id}
                                        className="hover:bg-violet-50/50 transition-colors duration-150 group"
                                    >
                                        <td
                                            onClick={() => handleRowClick(t)}
                                            className="p-4 font-semibold text-gray-900 cursor-pointer hover:text-violet-700 transition-colors"
                                        >
                                            {t.trainingType}
                                        </td>
                                        <td className="p-4 text-gray-700">{t.trainer}</td>
